...
public class BackendFoodflixApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat4 = new Categoria(null,"Pizzas");
		Categoria cat5 = new Categoria(null,"Refrigerantes");
		Categoria cat6 = new Categoria(null,"Porções");
		Categoria cat7 = new Categoria(null,"Sucos");
