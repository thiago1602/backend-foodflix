package com.thiagomoraes.foodflix.resources.exception;
...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DataIntegryException.class)
	public ResponseEntity<StandardError>
	dataIntegry(DataIntegryException e, HttpServletRequest request){
